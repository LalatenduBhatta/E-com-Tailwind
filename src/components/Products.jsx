                 ...
                 dark:bg-slate-800 dark:text-white py-4 flex flex-col justify-start items-center gap-10">
                    <div className='flex flex-col justify-start items-center gap-y-8 h-2/6'>
                        <div>
                            ...
                            <button id="dropdownBgHoverButton" data-dropdown-toggle="dropdownBgHover" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 
                    ...
                    dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Categories
                        ...
                        <div>
                            <button id="dropdownBgHoverButton1" data-dropdown-toggle="dropdownBgHover1" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 
                    focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1 md:px-4 md:py-2 text-center inline-flex items-center dark:bg-blue-600 
                                    ...
                                    return (
                                        <li key={category}>
                                            <div className="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                                <input type="checkbox" value={category} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded 
                    ...
                    <div>
                        ...
                        <button id="dropdownRadioBgHoverButton" data-dropdown-toggle="dropdownRadioBgHover" className="text-white bg-blue-700 hover:bg-blue-800 
                        focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  px-2 py-1 md:px-4 md:py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700
                         dark:focus:ring-blue-800" type="button">Sort <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        </button>
                    ...
                    {filterProduct.map(product => {
                        ...
                        rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" key={product.id}>
                                <Link to={`/products/${product.id}`}>
                                    <img className="p-8 rounded-t-lg h-[250px] w-[250px]" src={product.images[0]}
                                        alt="product image" />
                                </Link>
